export const idlFactory = ({ IDL }) => {
  ...
  const Badge = IDL.Record({
    ...
    'ava_link' : IDL.Text,
    'ic_link' : IDL.Text,
    'expert' : IDL.Vec(IDL.Tuple(IDL.Text, IDL.Text)),
  });
  ...
  const CategoryError = IDL.Variant({
    ...
    'NotFound' : IDL.Record({ 'message' : IDL.Text, 'docId' : DocId }),
    'BadFee' : IDL.Record({ 'expected_fee' : Tokens }),
    'WrongCipher' : IDL.Record({ 'cifer' : IDL.Text }),
  ...
  return IDL.Service({
    ...
    'getSoulboundBadge' : IDL.Func([IDL.Principal], [Badge], []),
    ...
    'initDoctokenDeployerReputation' : IDL.Func(
